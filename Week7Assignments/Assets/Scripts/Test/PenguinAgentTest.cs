...
public class PenguinAgentTest : Agent
{
    public float moveSpeed = 5f, turnSpeed = 180f;

    public GameObject heartPrefab;
    public GameObject regurgitatedFishPrefab;

    private PenguinAreaTest penguinArea;
    ...
    {
        //base.Initialize();
        penguinArea = GetComponentInParent<PenguinAreaTest>();
