...
public class BuildExcelWindow : EditorWindow
{
    ...
    private void Awake()
    {
        titleContent.text = "Excel Data Reader 数据读取";
    }
    ...
    private void GetExcelFile()
    {
        ...
        {
            showNotify = "Invailid Path 无效路径：" + ExcelDataReader.excelFilePath;
            return;
        }
        ...
        {
            showNotify = ExcelDataReader.excelFilePath + "No Excel file in the path 路径下没有找到文件";
            return;
        }
        ...
        showNotify = "Found Excel files 找到文件：" + fileNameList.Count;
    }
